...
int alpha_fast_route_proc(struct file *file, const char __user *buffer,
...
int alpha_fast_route_dump_status(char *page, char **start, off_t off, int count, int *eof, void *data)
{
	int ret=0;
    if (g_fast_route==0) 
    {
