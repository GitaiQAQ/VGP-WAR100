...
//Alpha
//polo add for encrypt 7-24
	(iw_handler) NULL,				/* SIOCGIWENCRYPT	 */
	(iw_handler) NULL,				/* SIOCGIAUTHTYPE	 */	
//polo
...
//Alpha
//polo add 7-24	
	case SIOCGIWENCRYPT: //Get ENCRYPT
	{
		break;
	}
	case SIOCGIAUTHTYPE: //Get AUTHTYPE
	{
		break;
	}	
//polo end	
