...
#endif
#if defined(CONFIG_RTL_LAYERED_ASIC_DRIVER_L4) && (defined(CONFIG_RTL_8198) ||defined(CONFIG_RTL_8196CT) ||defined(CONFIG_RTL_819XDT) || defined(CONFIG_RTL_8367R_SUPPORT))
...
/*layer4*/
#if defined(CONFIG_RTL_LAYERED_DRIVER_L4) && (defined(CONFIG_RTL_8198) ||defined(CONFIG_RTL_8196CT) ||defined(CONFIG_RTL_819XDT) || defined(CONFIG_RTL_8367R_SUPPORT))
	rtl865x_nat_init();
#endif
