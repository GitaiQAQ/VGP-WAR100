...
{
	set_result("FAILED", $FATLADY_prefix."/acl/inbfilter/count", I18N("h","The rules exceed maximum."));
	$rlt = "-1";
}
else
{
	foreach ($FATLADY_prefix."/acl/inbfilter/entry")
	{
		...
		foreach ($FATLADY_prefix."/acl/inbfilter/entry:".$INX."/iprange/entry")
		{
			...
			{
				set_result("FAILED",$FATLADY_prefix."/acl/inbfilter/entry:".$INX."/iprange/entry:".$INX2."/startip:".query("seq"),I18N("h","The start IP address is invalid."));
				$rlt = "-1";
				break;
			}	 
			if(INET_validv4addr(query("endip")) != 1)
			{
				set_result("FAILED",$FATLADY_prefix."/acl/inbfilter/entry:".$INX."/iprange/entry:".$INX2."/endip:".query("seq"),I18N("h","The end IP address is invalid."));
				$rlt = "-1";
				break;
			}
			...
			{
				set_result("FAILED",$FATLADY_prefix."/acl/inbfilter/entry:".$INX."/iprange/entry:".$INX2."/startip:".query("seq"),I18N("h","The start IP address could not be in LAN network."));
				$rlt = "-1";
				break;
			}
			...
			{
				set_result("FAILED",$FATLADY_prefix."/acl/inbfilter/entry:".$INX."/iprange/entry:".$INX2."/endip:".query("seq"),I18N("h","The end IP address could not be in LAN network."));
				$rlt = "-1";
				break;
			}			
			...
			if ($delta < 0)
			{
				set_result("FAILED",$FATLADY_prefix."/acl/inbfilter/entry:".$INX."/iprange/entry:".$INX2."/startip:".query("seq"),I18N("h","The end IP address should be greater than the start IP address."));
				$rlt = "-1";
				break;
			}	
		}	
