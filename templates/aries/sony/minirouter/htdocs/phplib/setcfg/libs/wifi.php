...
function phyinf_setcfg($prefix_phyinf, $minor)
{
	...
	//==20121226 jack add for sony mssid's wlmode set==//
	//==The wlmode node between each other should the same==//
...
function wifi_profile_setcfg($from, $to)
{
	...
	if(query("opmode") == "APCLI")
		set($to."/ssidremain",              query("ssidremain"));
