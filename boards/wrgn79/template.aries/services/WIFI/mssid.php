...
include "/etc/services/function.php";
...
//----------------------------------------------------------------------------------------------//		
				fwrite("a", $_GLOBALS["START"], 'iwpriv wlan0-va'.$mssidcount1.' set_mib MIMO_TR_mode=4\n');
...
//-----------------------protection for mssid end-------------------------------//								
				...
				fwrite("a", $_GLOBALS["START"], 'iwpriv wlan0-va'.$mssidcount1.' set_mib stbc=0\n');				
				fwrite("a", $_GLOBALS["START"], 'iwpriv wlan0-va'.$mssidcount1.' set_mib wifi_specific=2\n');

		$bssid=$bssid-1;
	//$mssidcount1=$mssidcount1-1;
